...
#include <malloc.h>
static inline size_t mx_get_malloc_usable_size(void *ptr) {
    return malloc_usable_size(ptr);
}
#elif defined(__APPLE__)
#include <malloc/malloc.h>
static inline size_t mx_get_malloc_usable_size(void *ptr) {
    return malloc_size(ptr);  // для macOS функция отличается
}
#else
static inline size_t mx_get_malloc_usable_size(void *ptr) {
    mx_printstr("Unsupported platform.\n");
    return 0;
}
#endif
